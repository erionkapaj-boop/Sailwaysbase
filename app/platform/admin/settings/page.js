...
const SETTING_META = {
  ...
  skipper_claim_fee: {
    ...
    unit: "€",
    help: "Χρεώνεται στον επαγγελματία τη στιγμή που διεκδικεί ένα αίτημα. Ίδιο για όλους.",
  },
  ...
  delivery_skipper_rate_per_mile: {
    label: "Μεταφορά — ρυθμός skipper",
    unit: "€/μίλι",
    help: "Βάση υπολογισμού της προμήθειας πλατφόρμας σε αιτήματα μεταφοράς σκάφους για skipper. Δεν είναι η αμοιβή του — αυτή συμφωνείται ελεύθερα.",
  },
  delivery_hostess_rate_per_mile: {
    label: "Μεταφορά — ρυθμός hostess",
    unit: "€/μίλι",
    help: "Ίδιο σκεπτικό, για hostess.",
  },
  delivery_cook_rate_per_mile: {
    label: "Μεταφορά — ρυθμός μάγειρα",
    unit: "€/μίλι",
    help: "Ίδιο σκεπτικό, για μάγειρα/μάγειρισσα.",
  },
  delivery_deckhand_rate_per_mile: {
    label: "Μεταφορά — ρυθμός ναύτη",
    unit: "€/μίλι",
    help: "Ίδιο σκεπτικό, για ναύτη.",
  },
  delivery_platform_fee_pct: {
    label: "Μεταφορά — ποσοστό προμήθειας",
    unit: "%",
    help: "Ποσοστό επί (μίλια × ρυθμός ρόλου) που αποτελεί τη συνολική προμήθεια πλατφόρμας ανά θέση.",
  },
  delivery_min_fee: {
    label: "Μεταφορά — ελάχιστο τέλος",
    unit: "€",
    help: "Κατώφλι που πληρώνει πάντα ο επαγγελματίας όταν αναλαμβάνει· ο πελάτης πληρώνει το υπόλοιπο πάνω από αυτό.",
  },
  delivery_expiry_hours: {
    label: "Μεταφορά — λήξη πρότασης",
    unit: "ώρες",
    help: "Πόσο μένει ανοιχτή μια πρόταση ρόλου σε μεταφορά πριν λήξει.",
  },
};
