...
const SETTING_META = {
  ...
  skipper_claim_fee: {
    label: "Τέλος διεκδίκησης (εγχώριο)",
    unit: "€",
    help: "Χρεώνεται στον επαγγελματία με ελληνικό αριθμό τηλεφώνου (+30) τη στιγμή που διεκδικεί ένα αίτημα.",
  },
  skipper_claim_fee_foreign: {
    label: "Τέλος διεκδίκησης (ξένο νούμερο)",
    unit: "€",
    help: "Χρεώνεται αντί του παραπάνω όταν ο επαγγελματίας έχει αριθμό τηλεφώνου άλλης χώρας — προστασία της εγχώριας αγοράς.",
  },
