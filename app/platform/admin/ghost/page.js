    ...
    >
      <Panel title="1. Μπες στην εφαρμογή ως ένας ψεύτικος λογαριασμός">
        <ol style={{ ...muted, margin: "0 0 12px", paddingLeft: 20, lineHeight: 1.7 }}>
          <li>
            Χρήστες, <b>Στοιχεία</b> του λογαριασμού.
          </li>
          <li>
            Στην κορυφή της σελίδας του πάτα <b>«Σύνδεση ως»</b> και γράψε σύντομα τον λόγο. Μπαίνεις πραγματικά ως
            αυτός και μπορείς να κάνεις ό,τι κάνει κι εκείνος.
          </li>
          <li>
            Για να γυρίσεις, πάτα <b>«Επιστροφή σε admin»</b> στη σκούρα μπάρα που μένει πάνω σε κάθε σελίδα.
          </li>
        </ol>
        <p style={{ ...muted, margin: "0 0 14px", fontSize: 13 }}>
          Δουλεύει σε οποιονδήποτε ενεργό λογαριασμό (όχι μόνο δοκιμών). Προσοχή: ο τωρινός κωδικός του σταματά να
          δουλεύει — σε πραγματικό χρήστη θα χρειαστεί μετά να του δώσεις «Νέο κωδικό». Κάθε χρήση καταγράφεται στο
          ιστορικό του λογαριασμού, με τον λόγο που έγραψες. Θες απλώς να <i>δεις</i> τι βλέπει ένας
          πραγματικός χρήστης, χωρίς να κάνεις τίποτα; Χρησιμοποίησε το <b>«Προβολή ως»</b>: μόνο για ανάγνωση.
        </p>
