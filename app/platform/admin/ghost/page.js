    ...
    >
      <Panel title="1. Μπες στην εφαρμογή ως ένας ψεύτικος λογαριασμός">
        ...
        <p style={{ ...muted, margin: "0 0 14px", fontSize: 13 }}>
          Δουλεύει σε οποιονδήποτε λογαριασμό (όχι μόνο δοκιμών) — ο κωδικός του επαναφέρεται αυτόματα και κάθε χρήση
          καταγράφεται στο ιστορικό του λογαριασμού, με τον λόγο που έγραψες. Θες απλώς να <i>δεις</i> τι βλέπει ένας
