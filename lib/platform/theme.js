...
// A standalone text link or text-only button, sized for a finger: 44px tall
// (Apple's guideline; WCAG's minimum is 24) without looking any bigger.
export const tapTarget = { display: "inline-flex", alignItems: "center", minHeight: 44 };
...
// Τιμές, ημερομηνίες, βαθμολογίες: ίδια γραμματοσειρά με το υπόλοιπο κείμενο,
// με αριθμούς ίσου πλάτους ώστε να στοιχίζονται. Η monospace έκανε κάθε
// ποσό να μοιάζει με κώδικα, όχι με απόδειξη.
export const money = {
  fontFamily: fontSans,
  fontWeight: 500,
