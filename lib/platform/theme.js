...
// Headings are serif — the editorial half of the type pairing.
export const h1 = {
...
export const badge = (tone = "neutral") => {
  const tones = {
    neutral: { bg: "#F2F0EB", fg: colors.inkSoft },
    brand: { bg: "#F2F0EB", fg: colors.ink },
