...
//
// skipper, hostess and cook are backed by real data (all live in
// skipper_profiles, distinguished by `role`, all searchable and bookable).
// deckhand still travels through the UI and query string only, and the
// results page says plainly that it returned nothing, until it gets its
// own step the way hostess and cook just did.
export const CREW_ROLES = [
  { key: "skipper", label: "Skipper", supported: true },
  { key: "hostess", label: "Hostess", supported: true },
  { key: "cook", label: "Cook", supported: true },
